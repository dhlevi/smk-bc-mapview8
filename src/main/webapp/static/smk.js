...
include.tag( "esri3d",
    {
        ...
        "tags": [
            ...
            {
                "external": true,
                "url": "https://js.arcgis.com/4.13/esri/themes/light/main.css",
                "loader": "style"
            },
            {
                "external": true,
...
include.tag( "tool-theme",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/theme/panel-theme.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/theme/tool-theme.css",
                "loader": "style"
            },
            {
                "url": "smk/tool/theme/tool-theme.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-viewer-toggle",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/viewer-toggle/panel-viewer-toggle.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/viewer-toggle/tool-viewer-toggle.css",
                "loader": "style"
            },
            {
                "url": "smk/tool/viewer-toggle/tool-viewer-toggle.js",
                "loader": "script"
            }
        ]
    }
        ...
        return ( window.SMK = Object.assign( {
            ...
            CONFIG: {
                ...
                tools: [
                    ...
                    { type: 'mapimageexport',enabled: false, order: 14,  position: 'list-menu',                       icon: 'photo_library',        title: 'Export Map Image' },
                    { type: 'viewer-toggle', enabled: false, order: 15,   position: 'list-menu',                        icon: 'backup',               title: '2D/3D toggle' },
                    { type: 'theme', enabled: false, order: 16,   position: 'list-menu',                        icon: 'backup',               title: 'Theme' }
