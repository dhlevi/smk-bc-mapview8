include.module( 'smk-map', [ 'jquery', 'util', 'theme-base' ], function () {
    ...
    SmkMap.prototype.initialize = function () {
        ...
        var spinner = $( '<img class="smk-startup smk-spinner" style="width: 280px; height: 280px; box-shadow: 1px 1px 5px 1px #88888833;" }>' )
            .attr( 'src', include.option( 'baseUrl' ) + 'img/splash-logo.png' )
